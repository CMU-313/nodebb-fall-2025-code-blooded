		...
		<div class="d-flex gap-2 flex-wrap">
			<div class="d-flex flex-column gap-3 flex-grow-1 flex-1">
				...
				<div class="topic-info d-flex gap-2 align-items-center flex-wrap {{{ if config.theme.centerHeaderElements }}}justify-content-center{{{ end }}}">
					<span component="topic/labels" class="d-flex gap-2 {{{ if (!scheduled && (!pinned && (!locked && (!endorsed && (!icons.length && (!oldCid || (oldCid == "-1"))))))) }}}hidden{{{ end }}}">
						...
						<span component="topic/endorsed" class="badge badge border border-warning text-body {{{ if !endorsed }}}hidden{{{ end }}}">
